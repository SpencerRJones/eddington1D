      ...
      subroutine absorb_clr(freqy, temp, pres, mixing_ratio, kabs_clear)
...
c       mixing_ratio :  mixing ratio of water vapor [g/kg] -Spencer Jones
c     OUTPUT
...
C +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      real  freqy, rho, temp, pres, vapor_pres, mixing_ratio
      real  R_d
      
c     Compute the vapor density, rho [g/m^3]      
c      rho = vapor_pres*100*18/(8.314*temp)
       R_d = 287.0 ![J/(kg K)]
       rho = mixing_ratio * (pres*100.)/(R_d*temp) ![g/m^3]

      call abs_H2O(temp, pres, rho, freqy, kabs_H2O) 
c        write(*,*) 'abs_H20', kabs_H2O     
      call abs_O2 (temp, pres, rho, freqy, kabs_O2)
c        write(*,*) 'abs_O2', kabs_O2 
      call abs_N2 (temp, pres, freqy, kabs_N2)
c        write(*,*) 'abs_N2', kabs_N2
